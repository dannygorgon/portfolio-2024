...
const Hero = () => {
  return (
    <section className="flex flex-col sm:flex-row items-center justify-center w-full mx-auto max-w-screen-xl space-x-4 sm:space-x-8 lg:space-x-16 xl:space-x-32 2xl:space-x-64">
