...
const TechStack = () => {
    ...
    <div className="mt-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 lg:grid-cols-7 gap-4">
        <div className="flex flex-col items-center">
          <img
  className="m-2 transition ease-in-out delay-70 hover:-translate-y-1 hover:scale-110 drop-shadow-md hover:drop-shadow-xl w-16 lg:w-20 xl:w-24 2xl:w-28"
  ...
  className="m-2 transition ease-in-out delay-70 hover:-translate-y-1 hover:scale-110 drop-shadow-md hover:drop-shadow-xl w-16 lg:w-20 xl:w-24 2xl:w-28"
            ...
            width={64}
          />
          <p className="mt-2 text-xs font-semibold">NextJS</p>
        </div>
        <div className="flex flex-col items-center">
          <img
  className="m-2 transition ease-in-out delay-70 hover:-translate-y-1 hover:scale-110 drop-shadow-md hover:drop-shadow-xl w-16 lg:w-20 xl:w-24 2xl:w-28"
  ...
  className="m-2 transition ease-in-out delay-70 hover:-translate-y-1 hover:scale-110 drop-shadow-md hover:drop-shadow-xl w-16 lg:w-20 xl:w-24 2xl:w-28"
            ...
            width={64}
          />
          <p className="mt-2 text-xs font-semibold">Mui/Material UI</p>
        </div>
        <div className="flex flex-col items-center">
          <img
  className="m-2 transition ease-in-out delay-70 hover:-translate-y-1 hover:scale-110 drop-shadow-md hover:drop-shadow-xl w-16 lg:w-20 xl:w-24 2xl:w-28"
